    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] bg-linear-to-r from-orange-100 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-8">
      <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 sm:p-8 w-full max-w-md border border-orange-100 dark:border-gray-700">
        ...
        <Motion.button
          ...
          className="w-full bg-orange-500 dark:bg-orange-600 text-white py-2 rounded-lg font-semibold hover:bg-orange-600 dark:hover:bg-orange-700 mb-3"
        ...
        <Motion.button
          whileHover={{ scale: 1.05 }}
          className="w-full border border-orange-500 dark:border-orange-600 text-orange-500 dark:text-orange-400 py-2 rounded-lg font-semibold hover:bg-orange-50 dark:hover:bg-gray-700 mb-3"
          onClick={async () => {
            try {
